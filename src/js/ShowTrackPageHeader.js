    ...
    const headerContainer = create('div', 'container', [
      create('div', 'trackDescription', [
        create('h2', 'trackDescription_title__primary', [
          ...
          create('img', 'icon_private0', null, null, ['src', icon_private], ['title', 'Трек приватный']),
        ]),
        create('h4', 'trackDescription_title__secondary', [
          create('span', 'trackDescription_authorName', ['aвтор: ', 'authorName. ']),
          create('span', 'trackDescription_data', ['дата: ', '2005.01.25']),
        ]),
      ]),
      menu,
      statisticsSmall,
