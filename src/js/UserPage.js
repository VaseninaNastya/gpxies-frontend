  ...
  async generateLayout() {
    ...
    const user_info = create("div", "user_info", [
      ...
      create(
        "span",
        "user_info_email",
        localStorage.getItem("gpxiesUserEmail")
      ),
    ]);
        ...
        create("div", "user_setting_favTracks", [
          ...
          create("div", "favoirites_chose_container", [
            create(
              "div",
              "language_item",
              `${this.wordsChooseArr.visibleToAll}`
            ),
    ...
    const user_content_container = create("div", "user_content_container", [
      user_info,
      user_setting,
      user_friends,
    ]);
    const trackListTable = new TrackListTable(null, `${this.wordsChooseArr.myTrackList}`);
    const user_tracks_container = create("div", "user_tracks_container", [
      create("div","user_tracks_container_hide"),
      trackListTable.generateLayout(),
    ]);
    const user_favtracks_container = create(
      "div",
    ...
    const user_container = create(
      "div",
      "user_container",
      create("div", "container", [
        user_content_container,
        user_tracks_container,
        user_favtracks_container,
      ])
    );

    document.body.prepend(
      create("div", "userPage_wrapper", [
